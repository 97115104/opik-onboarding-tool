...
### Developer tooling for AI assistants

Opik publishes AI-readable context for tools like Cursor:

- General context: https://www.comet.com/docs/opik/llms.txt
- Full context: https://www.comet.com/docs/opik/llms-full.txt
- MCP server: https://www.comet.com/docs/opik/_mcp/server
- Guidelines: https://www.comet.com/docs/opik/latest/contributing/overview#developer-tooling--ai-assistance
...
- If AI is used, include a `## AI Assistance` block in the PR description with tool/model, scope, human verification, and an attest link when applicable. Omit the section entirely when no AI was used.

Example (include only when AI was used):

```markdown
## AI Assistance
- Tool/model: Cursor (Auto) / <your model>
- Scope: implementation and tests for #1234
