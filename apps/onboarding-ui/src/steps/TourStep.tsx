...
export function TourStep() {
  ...
  const subtitle = personaSubtitle({
    default: 'Try Opik locally with a short guided checklist.',
    engineer: 'Confirm traces land before the quiz and issue pick.',
    pm: 'A hands-on walkthrough without deep tooling jargon.',
  ...
  return (
    <StepPanel testId="step-tour" title="Try Opik" subtitle={subtitle}>
      <p className="mb-4 text-sm text-slate-500">
        {completedCount} of {TOUR_ITEMS.length} steps marked done. You can continue anytime.
      </p>
